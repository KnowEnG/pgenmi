...
void model_list_to_mask(vector<vector<int>>& model_masks,
                        const string& model_list_str, int num_features) {
...
long double sig(long double w) { return (long double)1.0 / (1 + exp(-1 * w)); }
